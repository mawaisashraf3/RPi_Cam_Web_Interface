...
<html>
   <head>
      ...
      <title><?php echo "KFUEIT ACCESS SYSTEM"; ?></title>
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" <?php getdisplayStyle('navbar', $userLevel); ?>>
         <div class="container">
            <div class="navbar-header">
               <a class="navbar-brand" href="index.php"><?php echo "KFUEIT ACCESS SYSTEM"; ?></a>
         ...
         <div class="panel-group" id="accordion" <?php getdisplayStyle('settings', $userLevel); ?> >
            ...
            <div class="panel panel-default">
               ...
               <div id="collapseFour" class="panel-collapse collapse">
                  <div class="panel-body">
                    Project Creator: <a href="https://www.instagram.com/m.awaisashraf/" target="_blank">
M Awais Ashraf
                    </a><br>
                    Developed For: <a href="http://www.kfueit.edu.pk" target="_blank">
                       KFUEIT 
                    </a><br>
                    Contact: <a href="https://www.instagram.com/m.awaisashraf/">Email: Prof.AwaisAshraf@gmail.com</a>
                  </div>
               </div>
            </div>
         </div>
