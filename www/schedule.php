   ...
   function mainHTML() {
      ...
      echo '<html>';
         echo '<head>';
            ...
            echo '<title>' ."KFUEIT ACCESS SYSTEM" . ' Schedule</title>';
            ...
            echo '<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">';
               echo '<div class="container">';
                  echo '<div class="navbar-header">';
                     ...
                     echo '<span class="glyphicon glyphicon-chevron-left"></span>Back - ' . "KFUEIT ACCESS SYSTEM" . '</a>';

echo '<button onclick="openFullscreen();"><i class="fa fa-search-plus"></i></button>
<button onclick="closeFullscreen();"><i class="fa fa-search-minus"></i></button>';
            ...
            echo '<script src="js/fullscreen.js"></script>';
         echo '</body>';
      echo '</html>';
   }
