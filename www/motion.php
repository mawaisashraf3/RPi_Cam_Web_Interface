...
<html>
   <head>
      ...
      <title>KFUEIT ACCESS SYSTEM (Download)</title>
...
<button onclick="closeFullscreen();"><i class="fa fa-search-minus"></i></button>
      ...
      if ($motionReady) {
         ...
         echo "<h1>Motion not running. Put in detection state

         </h1>";

         echo "<h2> Please Contact to Web Master:<h3>M Awais Ashraf    Email: Prof.AwaisAshraf@gmail.com</h3>
